...
# Instantiate the knowledge source with dynamic path
pdf_path = Path(__file__).parent.parent.parent.parent / "Union_Budget_Analysis-2023-24.pdf"
union_data = UnionBudgetKnowledgeSource(file_path=str(pdf_path))
